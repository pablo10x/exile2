...
namespace Salvage.ClothingCuller.Editor.EditorWindows
{
    ...
    {
        public ClothingCullerConfiguration Config => selectedClothingCullerConfiguration;
        ...
        private bool isConfigurationSelectorVisible;
        ...
        private void OnGUI()
        {
            ...
            if (isConfigurationSelectorVisible)
            {
                drawConfigurationSelector();
            }
        ...
        private void drawConfigurationSelector()
        {
            ...
            EditorGUILayout.LabelField("Clothing Culler Configuration", GUILayout.ExpandWidth(false));
            selectedClothingCullerConfiguration = EditorGUILayout.ObjectField("", selectedClothingCullerConfiguration, typeof(ClothingCullerConfiguration), false) as ClothingCullerConfiguration;
        ...
        private void drawToolbar()
        {
            ...
            isConfigurationSelectorVisible = GUILayout.Toggle(isConfigurationSelectorVisible, "Change Configuration", EditorStyles.toolbarButton, GUILayout.ExpandWidth(false));
        ...
        private void validatePrefabs()
        {
            ...
            foreach (OccludeeCategory occludeeCategory in selectedClothingCullerConfiguration.OccludeeCategories)
            {
        ...
        private void removeNullValuesAndUnusedDataFromConfig()
        {
            foreach (OccludeeCategory occludeeCategory in selectedClothingCullerConfiguration.OccludeeCategories)
            {
                ...
                {
                    EditorUtility.SetDirty(selectedClothingCullerConfiguration);
                }
        ...
        public void Reload()
        {
            if (selectedClothingCullerConfiguration == null || PrefabsTreeView == null || occludeesTreeView == null || occludersTreeView == null)
            {
                return;
            }

            titleContent.text = $"Edit Configuration ({selectedClothingCullerConfiguration.name})";
            ...
            if (selectedClothingCullerConfiguration.IsModularClothingWorkflowEnabled)
            {
