...
namespace Salvage.ClothingCuller.Configuration
{
    ...
    public class MeshOcclusionData
    {
        ...
        public bool HasOcclusionData(string lodId)
        {
        ...
        public void CreateTriangleOcclusionDataIfNotExists(string lodId)
        {
            if (HasOcclusionData(lodId))
            {
                return;
            }

            var serializableBoolArray = new SerializableBoolArray { Value = new bool[originalSharedMesh.triangles.Length] };
