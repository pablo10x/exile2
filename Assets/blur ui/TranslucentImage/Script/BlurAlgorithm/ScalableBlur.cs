...
public class ScalableBlur : IBlurAlgorithm
{
    ...
    Material Material
    {
        get
        {
            if (material == null)
            {
                ...
                kwBackgroundFillNone  = new LocalKeyword(shader, "BACKGROUND_FILL_NONE");
                kwBackgroundFillColor = new LocalKeyword(shader, "BACKGROUND_FILL_COLOR");
                kwUseExtraSample      = new LocalKeyword(shader, "USE_EXTRA_SAMPLE");
            }
    ...
    )
    {
        ...
        // propertyBlock.SetInt("_IsLast", 1);
    ...
    protected void ConfigMaterial(BackgroundFill backgroundFill)
    {
        ...
        case BackgroundFillMode.None:
            Material.SetKeyword(kwBackgroundFillNone,  true);
            Material.SetKeyword(kwBackgroundFillColor, false);
            break;
        case BackgroundFillMode.Color:
            Material.SetKeyword(kwBackgroundFillColor, true);
            Material.SetKeyword(kwBackgroundFillNone,  false);
            Material.SetColor(ShaderID.BACKGROUND_COLOR, backgroundFill.color);
            break;
        }
        Material.SetKeyword(kwUseExtraSample, config.Mode == ScalableBlurConfig.BlurMode.Balanced);
    }
