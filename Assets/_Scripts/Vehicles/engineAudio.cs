  ...
  //  private inputs IN;
    ...
    private void Start(){
       ...
       // IN = transform.root.gameObject.GetComponent<inputs>();
        ...
        lowPitchMax = (m_CarController.controllerV4.maxEngineRPM / 1000) / 2;
    ...
    private void FixedUpdate(){
        ...
        accFade = Mathf.Lerp(accFade,Mathf.Abs( acceleration ), 15 * Time.deltaTime );
            ...
            if(m_CarController.controllerV4.fuelInput> 0)
                acceleration = 1;
            else acceleration = 0;

            float pitch = ULerp(lowPitchMin, lowPitchMax, m_CarController.controllerV4.engineRPM / m_CarController.controllerV4.maxEngineRPM);
            ...
            float highFade = Mathf.InverseLerp(0.2f, 0.8f,  m_CarController.controllerV4.engineRPM / m_CarController.controllerV4.maxEngineRPM);
