...
namespace Exile.Inventory.Examples
{
    ...
    public class SizeInventoryExample : MonoBehaviour
    {
        ...
        [SerializeField] private ItemBase[] _definitions = null;
        ...
        void Start()
        {
            ...
            // Create inventory
             inventory = new InventoryManager(provider, _width, _height, _allowedItem == ItemType.Any);
            ...
            {
                Debug.Log((item as ItemBase).Name + " was dropped on the ground");
            };
            ...
            {
                Debug.Log($"You can't put {(item as ItemBase).Name} there!");
            };
        }
[Button("Resize")]
        public void rz() {
            inventory.Resize(_width, _height);
        }
    }
}