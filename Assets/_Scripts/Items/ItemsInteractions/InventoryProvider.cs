...
namespace Exile.Inventory.Examples
{
    public class InventoryProvider : IInventoryProvider
    {
        ...
        /// CTOR
        /// </summary>
        public InventoryProvider(InventoryRenderMode renderMode = InventoryRenderMode.Grid, int maximumAlowedItemCount = -1, ItemType allowedItem = ItemType.Any)
        {
        ...
        public bool CanAddInventoryItem(IInventoryItem item)
        {
            ...
            return (item as ItemBase).Type == _allowedItem;
        }
